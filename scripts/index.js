...
let inputNameNew = popupElement.querySelector('.popup__input_type-name');
let inputJobNew = popupElement.querySelector('.popup__input_type-occupation');
const formButtomSubmit = document.querySelector('.popup__button-submit');
//открыли
function openPopup () {
